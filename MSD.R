...
ggsave("MSD_single_trajectories.png", plot=a, width = 11, height = 8.5, dpi=300)
...
ggsave("MSD_ensemble_average_SD.png", plot=b, width = 11, height = 8.5, dpi=300)
...
ggsave("MSD_ensemble_average.png", plot=c, width = 11, height = 8.5, dpi=300)
...
ggsave("MSD_ensemble_average_nb_tracks.png", plot=d, width = 11, height = 8.5, dpi=300)
